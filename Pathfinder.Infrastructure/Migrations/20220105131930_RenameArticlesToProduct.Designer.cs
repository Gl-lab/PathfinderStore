...
namespace Pathfinder.Infrastructure.Migrations
{
    ...
    [Migration("20220105131930_RenameArticlesToProduct")]
    partial class RenameArticlesToProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.Permissions.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.Role.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "292963a7-1ca0-4f1c-9acc-dc8cd976602c",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "a1b665fc-8fa8-423d-8906-06eb178373f5",
                            IsSystemDefault = true,
                            Name = "Member",
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.Role.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.Role.RolePermission", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.User.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 5,
                            ConcurrencyStamp = "ccf84999-84d1-4365-ab11-9d9c34710b41",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 5,
                            ConcurrencyStamp = "9747ceed-0095-40ab-953c-1b98459fd7a0",
                        ...
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 5,
                            ConcurrencyStamp = "b698fa94-e6a5-4cc8-b7c3-397aa4bee9e5",
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.User.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.User.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.User.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.User.UserToken", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Product.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Account.Account", b =>
                {
                    ...
                    b.HasOne("Pathfinder.Core.Entities.Authentication.User.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.Role.RoleClaim", b =>
                {
                    b.HasOne("Pathfinder.Core.Entities.Authentication.Role.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.Role.RolePermission", b =>
                {
                    b.HasOne("Pathfinder.Core.Entities.Authentication.Permissions.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pathfinder.Core.Entities.Authentication.Role.Role", "Role")
                        .WithMany("RolePermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Authentication.User.UserClaim", b =>
                {
                    b.HasOne("Pathfinder.Core.Entities.Authentication.User.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Product.Effect", b =>
                {
                    b.HasOne("Pathfinder.Core.Entities.Product.Product", null)
                        .WithMany("Effects")
            ...
            modelBuilder.Entity("Pathfinder.Core.Entities.Product.Item", b =>
                {
                    b.HasOne("Pathfinder.Core.Entities.Product.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
