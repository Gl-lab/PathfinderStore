...
public sealed class SpellRepository : ISpellRepository
{
    ...
    private static IReadOnlyCollection<SpellDefinition> CreateSpells()
    {
        ...
        [
            ...
            Create( "Caustic Blast", SpellKind.Cantrip, "AP", "Acid|Cantrip|Concentrate|Manipulate", SpellRarity.Common, "Player Core", 319 ),
            ...
            Create( "Electric Arc", SpellKind.Cantrip, "AP", "Cantrip|Concentrate|Electricity|Manipulate", SpellRarity.Common, "Player Core", 328 ),
            Create( "Figment", SpellKind.Cantrip, "AO", "Cantrip|Concentrate|Illusion|Manipulate|Subtle", SpellRarity.Common, "Player Core", 331 ),
            Create( "Forbidding Ward", SpellKind.Cantrip, "DO", "Cantrip|Concentrate|Manipulate", SpellRarity.Common, "Player Core", 332 ),
            Create( "Frostbite", SpellKind.Cantrip, "AP", "Cantrip|Cold|Concentrate|Manipulate", SpellRarity.Common, "Player Core", 332 ),
            Create( "Gouging Claw", SpellKind.Cantrip, "AP", "Attack|Cantrip|Concentrate|Manipulate|Morph", SpellRarity.Common, "Player Core", 333 ),
            Create( "Guidance", SpellKind.Cantrip, "DOP", "Cantrip|Concentrate", SpellRarity.Common, "Player Core", 334 ),
            Create( "Ignition", SpellKind.Cantrip, "AP", "Attack|Cantrip|Concentrate|Fire|Manipulate", SpellRarity.Common, "Player Core", 336 ),
            ...
            Create( "Tangle Vine", SpellKind.Cantrip, "AP", "Attack|Cantrip|Concentrate|Manipulate|Plant|Wood", SpellRarity.Common, "Player Core", 362 ),
            Create( "Telekinetic Hand", SpellKind.Cantrip, "AO", "Cantrip|Concentrate|Manipulate", SpellRarity.Common, "Player Core", 362 ),
            ...
            Create( "Ant Haul", SpellKind.Spell, "AP", "Concentrate|Manipulate", SpellRarity.Common, "Player Core", 315 ),
            ...
            Create( "Detect Poison", SpellKind.Spell, "DP", "Concentrate|Detection|Manipulate|Uncommon", SpellRarity.Uncommon, "Player Core", 323 ),
            Create( "Disguise Magic", SpellKind.Spell, "AO", "Concentrate|Illusion|Manipulate", SpellRarity.Common, "Player Core", 324 ),
            ...
            Create( "Gentle Landing", SpellKind.Spell, "AP", "Air|Concentrate", SpellRarity.Common, "Player Core", 333 ),
            Create( "Grease", SpellKind.Spell, "AP", "Concentrate|Manipulate", SpellRarity.Common, "Player Core", 333 ),
            Create( "Grim Tendrils", SpellKind.Spell, "AO", "Concentrate|Manipulate|Void", SpellRarity.Common, "Player Core", 334 ),
            ...
            Create( "Hydraulic Push", SpellKind.Spell, "AP", "Attack|Concentrate|Manipulate|Water", SpellRarity.Common, "Player Core", 336 ),
            Create( "Ill Omen", SpellKind.Spell, "O", "Concentrate|Curse|Manipulate|Misfortune", SpellRarity.Common, "Player Core", 336 ),
            Create( "Infuse Vitality", SpellKind.Spell, "D", "Concentrate|Manipulate|Vitality", SpellRarity.Common, "Player Core", 338 ),
            Create( "Item Facade", SpellKind.Spell, "AO", "Concentrate|Illusion|Manipulate|Visual", SpellRarity.Common, "Player Core", 340 ),
            ...
            Create( "Pest Form", SpellKind.Spell, "AP", "Concentrate|Manipulate|Polymorph", SpellRarity.Common, "Player Core", 348 ),
            Create( "Phantasmal Minion", SpellKind.Spell, "AO", "Concentrate|Manipulate|Summon", SpellRarity.Common, "Player Core", 349 ),
            Create( "Protection", SpellKind.Spell, "DO", "Concentrate|Manipulate", SpellRarity.Common, "Player Core", 351 ),
            Create( "Pummeling Rubble", SpellKind.Spell, "AP", "Concentrate|Earth|Manipulate", SpellRarity.Common, "Player Core", 351 ),
            ...
            Create( "Soothe", SpellKind.Spell, "O", "Concentrate|Emotion|Healing|Manipulate|Mental", SpellRarity.Common, "Player Core", 357 ),
            ...
            Create( "Summon Construct", SpellKind.Spell, "A", "Concentrate|Manipulate|Summon", SpellRarity.Common, "Player Core", 360 ),
            Create( "Summon Fey", SpellKind.Spell, "OP", "Concentrate|Manipulate|Summon", SpellRarity.Common, "Player Core", 360 ),
            Create( "Summon Plant or Fungus", SpellKind.Spell, "P", "Concentrate|Manipulate|Summon", SpellRarity.Common, "Player Core", 361 ),
            Create( "Sure Strike", SpellKind.Spell, "AO", "Concentrate|Fortune", SpellRarity.Common, "Player Core", 361 ),
            Create( "Tailwind", SpellKind.Spell, "AP", "Air|Concentrate|Manipulate", SpellRarity.Common, "Player Core", 362 ),
            Create( "Thunderstrike", SpellKind.Spell, "AP", "Concentrate|Electricity|Manipulate|Sonic", SpellRarity.Common, "Player Core", 363 ),
            Create( "Vanishing Tracks", SpellKind.Spell, "P", "Concentrate|Manipulate", SpellRarity.Common, "Player Core", 365 ),
