...
Человекочитаемый обзор проекта: цель, стек, архитектура, структура solution, dev setup и текущий статус модулей. Корневой `README.md` служит краткой точкой входа, а этот раздел содержит подробный источник истины.

### [`10_workflow/`](10_workflow)

Правила работы в проекте: sandbox, Vikunja, EF migrations, C# style, локальная observability и исследовательский workflow.
