...
- [equipment_inventory_boundary.md](equipment_inventory_boundary.md) — ownership каталога и комплекта экипировки в `CharacterManagement`, миграция в runtime `Inventory` и граница с `Commerce`.
