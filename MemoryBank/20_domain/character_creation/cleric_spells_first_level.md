...
## Набор заклинаний первого уровня
...
Legacy rows после миграции получают пустые JSONB-коллекции и остаются читаемыми. Строгая проверка полного набора заклинаний применяется к созданию нового Cleric.
