...
- Skill feats, equipment, languages и исполняемые ancestry feats не участвуют в MVP flow. Deity package, primary Domain choice Cloistered Cleric, spell loadout, derived Domain focus pool и Background/class skill training уже применяются; исполнение spell effects пока остаётся за границей MVP.
