...
- Class skills, skill feats, spells, deity, equipment, languages и ancestry feats не участвуют в MVP flow. Background skill/Lore training уже применяется.
...
Starting proficiencies для Perception, saves, attacks, defenses и class DC вычисляются из выбранного класса и отображаются в карточке. Skills, spell proficiencies, class features, spells и mandatory choices пока не применяются. Racket-зависимая альтернативная key ability Rogue ожидает отдельный Rogue's Racket flow.
...
3. Добавить languages, deity, spells/cantrips и equipment по мере готовности соответствующих подсистем.
