...
1. Типизировать skills/Lore и применить background grants.
2. Типизировать starting proficiencies классов.
3. Реализовывать обязательные class choices отдельными flows, начиная с Rogue's Racket.
4. Добавить languages, deity, spells/cantrips и equipment по мере готовности соответствующих подсистем.
5. Расширять derived statistics и combat HP state отдельными vertical slices.
