...
Текущий реализованный flow включает имя, `Ancestry`, ancestry package, ancestry boosts/flaws, `Background` с двумя boosts и `Class` с key ability boost.

Следующие gaps известны, но не блокируют текущий MVP:

- Четыре финальных свободных boosts ещё не участвуют в создании персонажа.
...
3. Добавить четыре финальных boosts.
4. Добавить languages.
5. Добавить deity, spells/cantrips и equipment по мере появления соответствующих class flows.
