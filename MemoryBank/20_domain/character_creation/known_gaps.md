...
3. Priority 11–17 из roadmap завершены: реализованы экземпляры и инвентарь, обмен, магазины, инструменты ведущего, воспроизводимая генерация ассортимента и расширенный runtime lifecycle предметов. Следующий предметный этап — оставшийся торговый UI в Priority 18.
