...
1. Типизировать starting proficiencies классов и подключить их к общему training foundation.
2. Реализовывать обязательные class choices отдельными flows, начиная с Rogue's Racket.
