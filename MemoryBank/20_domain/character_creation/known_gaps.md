...
3. После завершённых боевой карточки, Priority 9 и Priority 10 выполнять Priority 11–16 из roadmap: экземпляры и инвентарь, обмен, магазины, инструменты ведущего, генерацию и расширенный жизненный цикл предметов.
