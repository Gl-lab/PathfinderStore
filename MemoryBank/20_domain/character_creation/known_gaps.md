...
3. После завершённых боевой карточки и Priority 9 выполнять Priority 10–16 из roadmap: каталог v2, экземпляры и инвентарь, обмен, магазины, инструменты ведущего, генерацию и жизненный цикл предметов.
