...
| Боевая интеграция | Прямое чтение минимального каталога | Прикладной порт собранного описания экземпляра |
...
2. Точный список компонентов первого релиза и формат параметров редких эффектов.
3. Является ли размер частью переиспользуемой конфигурации всегда или допускается неизменяемым параметром экземпляра для простых предметов.
