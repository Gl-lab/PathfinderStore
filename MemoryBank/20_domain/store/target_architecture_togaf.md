...
- личные, партийные, магазинные и мировые корневые контейнеры представлены `InventoryContainer`; подключение операций общего хранилища партии относится к Priority 12;
...
- произвольные runtime-команды передачи, магазины, сделки, заряды, расходование, руны и повреждение предметов отсутствуют;
...
- runtime-команды пока не экспонированы application/API слоем;
- вложенные контейнеры и передача между владельцами относятся к следующим этапам;
...
- корневое хранилище партии ещё не связано с пользовательскими командами получения и передачи предметов;
...
| Этап 4 | Priority 12: обмен партии |
...
25. Priority 8, Priority 9, Priority 10 и Priority 11 завершены; обмен и торговля следуют по Priority 12–16.
