...
- автоматическое пополнение ассортимента, заряды, расходование, руны и повреждение предметов отсутствуют;
...
| Состояние | Количество, расположение, версия и lifecycle экземпляра; charge/durability runtime state отсутствует | Заряды, прочность и прикрепления |
...
25. Priority 8–16 завершены; расширенный жизненный цикл предметов следует в Priority 17, оставшийся торговый UI — в Priority 18.
