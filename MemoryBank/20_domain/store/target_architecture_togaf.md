...
**Статус Priority 14:** завершён; итоговая проверка зафиксирована в [Priority 14 Final Cross-Review](../../30_task_notes/priority_14_final_review.md). Воспроизводимая генерация ассортимента остаётся Priority 15.
