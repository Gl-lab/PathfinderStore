...
| Боевая интеграция | Application-owned порт с Web-адаптером ItemCatalog и starting fallback | Прикладной порт собранного описания экземпляра после Priority 11 |
...
25. Priority 8, Priority 9 и Priority 10 завершены; экземпляры, обмен и торговля следуют по Priority 11–16.
