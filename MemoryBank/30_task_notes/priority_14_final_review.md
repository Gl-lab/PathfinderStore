...
Priority 14 завершён: ведущий может создавать campaign-scoped уникальные предметы, сервер отделяет authoritative свойства от видимого представления, знания различаются по персонажу и партии, скрытое ограничение действует до раскрытия, а принудительные операции имеют обязательную причину и отдельный аудит. После появления детального UI-пакета следующий ограниченный этап roadmap пересмотрен: Priority 15 содержит блокирующие read-проекции Inventory/Commerce и UI MVP-1 для страницы кампании, инвентаря, дарения и партийного хранилища; воспроизводимая генерация ассортимента перенесена в Priority 16.
