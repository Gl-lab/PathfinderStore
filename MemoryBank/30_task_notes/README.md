...
Этот раздел хранит локальные статусные заметки по крупным задачам и эпикам.

Vikunja остаётся источником истины по фактическому статусу карточек. Здесь фиксируются инженерный контекст, связанные документы и next steps, чтобы не восстанавливать картину по разрозненным обсуждениям.
...
- [`domain_glossary_task.md`](domain_glossary_task.md)
- [`character_gender_and_avatars.md`](character_gender_and_avatars.md)
...
- [`priority_5_final_review.md`](priority_5_final_review.md)
- [`priority_6_final_review.md`](priority_6_final_review.md)
- [`priority_7_final_review.md`](priority_7_final_review.md)
- [`priority_8_final_review.md`](priority_8_final_review.md)
