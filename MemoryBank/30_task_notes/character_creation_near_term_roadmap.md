...
Стартовый pipeline характеристик завершён. Background skill/Lore grants и стартовые class proficiencies применяются типизированно; class features и ancestry effects пока остаются декларативными.
...
Статус: реализовано. Подробный scope, контракты и результаты зафиксированы в [Hit Points v1 Implementation Plan](hit_points_v1_implementation.md).
...
Статус: реализовано. Подробный scope, доменные решения и результаты проверок зафиксированы в [Skills и Lore Foundation Implementation Plan](skills_lore_foundation_implementation.md).
...
Статус: реализовано. Подробный scope, доменные решения и результаты проверок зафиксированы в [Class Proficiency Foundation Implementation Plan](class_proficiency_foundation_implementation.md).
